...
class User extends Model
{
    ...
    {
        return $this->db->table($this->table)->where($data)->orderBy("id_user", "DESC")->get(1)->getRowArray();
    }
    ...
    function up()
    {
        return $this->db->query("CREATE TABLE `user` (`id_user` int(11) NOT NULL auto_increment,`name` varchar(200) NOT NULL ,`password` text NOT NULL ,`email` varchar(200) NOT NULL ,    PRIMARY KEY (`id_user`)
